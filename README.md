...
## 2. FinBERT Positive vs Negative Scatter

일별 Positive/Negative 감성 확률 분포를 Scatter Plot으로 시각화하였다.

![FinBERT Scatter](outputs/figures/finbert_pos_vs_neg_scatter.png)

---

## 3. FinBERT Predicted Sentiment Distribution
...
## 4. Monthly FinBERT Sentiment Trend
